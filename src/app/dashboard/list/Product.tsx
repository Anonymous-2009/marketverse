      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <Label htmlFor="productImages">Product Images (3-5 images required)</Label>
              <div
              ...
              >
                ...
                {selectedImages.length === 0 ? (
                  ...
                  >
                    ...
                    <span className="text-gray-600 font-medium">Drop your images here or click to upload</span>
                    <span className="text-gray-500 text-sm mt-2">Support for up to 5 images</span>
                  </label>
                ) : (
              ...
              {selectedImages.length < 3 && 
                <p className="text-red-500 text-sm mt-1">Please upload at least 3 images</p>
              }
            </div>
